        ...
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #ddd;">
                ...
                <div style="background: linear-gradient(135deg, #004d99, #0066cc); color: white; padding: 20px; text-align: center;">
                    <img src="https://shree-ram-travels.vercel.app/WhatsApp Image 2025-12-29 at 8.28.19 PM-Photoroom (1).png" alt="Shree Ram Tour and Travels" style="height: 60px; width: auto; margin-bottom: 10px; background: white; padding: 5px; border-radius: 5px;" />
